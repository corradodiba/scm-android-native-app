...
public class GetUsersActivity extends MenuActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_get_users, null, false);
        drawer.addView(contentView, 0);
        navigationView.setCheckedItem(R.id.nav_view_users_list);
    ...
    private void jsonrequestUser() {
        ...
        request = new JsonArrayRequest( Request.Method.GET, URLs.URL_USERS, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d( "Error: ", error.getMessage() );
                    ...
                    Toast.makeText( GetUsersActivity.this, "Network failure", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        requestQueue = Volley.newRequestQueue( GetUsersActivity.this);
