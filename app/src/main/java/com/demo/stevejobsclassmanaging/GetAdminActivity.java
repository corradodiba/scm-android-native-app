...
public class GetAdminActivity extends MenuActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_get_admin, null, false);
        drawer.addView(contentView, 0);
        navigationView.setCheckedItem(R.id.nav_view_admin_list);
        lstUser = new ArrayList<>();
        recyclerView = findViewById(R.id.recyclerviewidAdmin);
        jsonrequestAdmin();
    ...
    private void jsonrequestAdmin() {

        request = new JsonArrayRequest(  Request.Method.GET, URLs.URL_ADMIN, new Response.Listener<JSONArray>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText( GetAdminActivity.this, "Network failure", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        requestQueue = Volley.newRequestQueue( GetAdminActivity.this);
